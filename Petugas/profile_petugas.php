...
try {
    ...
    header('Location: petugas_dashboard');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_profile'])) {
    ...
    if($stmt->rowCount() > 0) {
        ...
        try {
            $stmt = $conn->prepare("UPDATE users SET full_name = :full_name, email = :email, phone = :phone WHERE id = :id");
            $stmt->execute([
                'full_name' => $full_name,
                'email' => $email,
                'phone' => $phone,
...
<head>
    ...
    <title>Profile - Petugas Dashboard</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .avatar-large {
            ...
            overflow: hidden;
            position: relative;
            box-shadow: 0 4px 15px rgba(55, 81, 254, 0.3);
            cursor: pointer;
            transition: all 0.3s;
        }
        ...
        .avatar-large:hover {
            ...
            box-shadow: 0 6px 20px rgba(55, 81, 254, 0.5);
        }
    ...
    <div class="container">
        ...
        <div class="profile-container">
            ...
            <div class="profile-content">
                ...
                <div class="profile-card">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($user['phone'] ?? ''); ?>" placeholder="Masukkan nomor telepon">
                        </div>
                        
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> 
                            Informasi profile akan digunakan untuk komunikasi dan notifikasi sistem.
                        </div>
                ...
                <div class="profile-card">
                    <div class="card-title">
                        <i class="fas fa-image"></i> Foto Profile
                    </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="file-upload-area" onclick="document.getElementById('file_input').click()">
                            ...
                            <div class="max-size">
                                <i class="fas fa-info-circle"></i> Maksimal: 5MB
                            </div>
                        ...
                        <div class="btn-group">
                            ...
                            <?php if($user['profile_picture']): ?>
                                <a href="profile_petugas.php?delete_picture=1" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus foto profile?')">
                ...
                <div class="profile-card">
                    ...
                    <div style="display: grid; gap: 15px;">
                        <div class="form-group">
                            <label>ID Akun</label>
                            <input type="text" value="<?php echo $user['id']; ?>" readonly style="background: #f9fafb; cursor: not-allowed;">
                        </div>
                        
                        <div class="form-group">
                            <label>Role</label>
                            <input type="text" value="<?php echo ucfirst($user['role']); ?>" readonly style="background: #f9fafb; cursor: not-allowed;">
                        </div>
                        
                        <div class="form-group">
                            <label>Tanggal Daftar</label>
                            <input type="text" value="<?php echo date('d M Y, H:i', strtotime($user['created_at'])); ?>" readonly style="background: #f9fafb; cursor: not-allowed;">
                        </div>
                        
                        <div class="form-group">
                            <label>Terakhir Update</label>
                            <input type="text" value="<?php echo date('d M Y, H:i', strtotime($user['updated_at'])); ?>" readonly style="background: #f9fafb; cursor: not-allowed;">
                        </div>
                    </div>
