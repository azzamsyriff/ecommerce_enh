...
try {
    ...
    // Ambil statistik dari database (hanya yang relevan untuk petugas)
...
<head>
    ...
    <title>Petugas Dashboard - E-Commerce Platform</title>
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* ... (style yang sama persis dengan admin_dashboard.php) ... */
        * {
            margin: 0;
            padding: 0;
        ...
        /* ... (copy semua style dari admin_dashboard.php) ... */
        /* Sidebar */
        .sidebar {
            width: 280px;
...
<body>
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                <div class="modal-options">
                    <a href="laporan_transaksi_petugas.php" class="modal-option">
                    ...
                    <a href="laporan_penjualan_petugas.php" class="modal-option">
                    ...
                    <a href="laporan_stok_petugas.php" class="modal-option">
    ...
    <div class="modal-overlay" id="produkModal">
        <div class="modal">
            ...
            <div class="modal-body">
                <div class="modal-options">
                    <a href="tambah_produk_petugas.php" class="modal-option">
                    ...
                    <a href="kelola_produk_petugas.php" class="modal-option">
                    ...
                    <!-- <a href="kelola_produk_petugas.php" class="modal-option">
                        ...
                        <div class="modal-option-text">
                            <div class="modal-option-title">Ubah/Hapus Produk</div>
                            <div class="modal-option-desc">Edit or delete products</div>
                        </div>
                    </a> -->
                </div>
            </div>
    ...
    <!-- Sidebar - DISESUAIKAN UNTUK PETUGAS -->
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="petugas_dashboard.php" class="menu-item active">
                    <i class="fas fa-home menu-icon"></i>
                    <span class="menu-text">Dashboard</span>
                </a>
            </div>
            
            <!-- Management Section - DISESUAIKAN -->
            <div class="menu-section">
                <div class="menu-title">Management</div>
                <a href="kelola_user_petugas.php" class="menu-item">
                ...
                <div class="submenu" id="produkSubmenu">
                    <a href="tambah_produk_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-plus"></i>
                        <span class="menu-text">Tambah Produk</span>
                    </a>
                    <a href="kelola_produk_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-list"></i>
                        <span class="menu-text">Kelola Produk</span>
                    </a>
                    <!-- <a href="kelola_produk_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-edit"></i>
                        <span class="menu-text">Ubah/Hapus Produk</span>
                    </a> -->
                </div>
                <a href="kelola_transaksi_petugas.php" class="menu-item">
            ...
            <div class="menu-section">
                ...
                <div class="submenu" id="laporanSubmenu">
                    <a href="laporan_transaksi_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-file-invoice"></i>
                        <span class="menu-text">Laporan Transaksi</span>
                    </a>
                    <a href="laporan_penjualan_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-chart-line"></i>
                        <span class="menu-text">Laporan Penjualan</span>
                    </a>
                    <a href="laporan_stok_petugas.php" class="menu-item submenu-item">
                        <i class="fas fa-boxes"></i>
                        <span class="menu-text">Laporan Stok</span>
                    </a>
                </div>
                <a href="backup_restore_petugas.php" class="menu-item">
            ...
            <div class="menu-section">
                ...
                <a href="profile_petugas.php" class="menu-item">
    ...
    <div class="main-content">
        ...
        <div class="header">
            ...
            <div class="header-right">
                ...
                <div class="user-profile" onclick="window.location.href='profile_petugas.php'">
                    <div class="avatar">
        ...
        <div class="dashboard-content">
            <h1 class="page-title">Petugas Dashboard</h1>
            <p class="page-subtitle">Welcome back, <?php echo $current_user['full_name']; ?>! Manage e-commerce activities from here.</p>
            
            <!-- Stats Cards - DISESUAIKAN -->
            ...
            <!-- Quick Actions - DISESUAIKAN -->
            <div class="quick-actions">
                <div class="action-card" onclick="window.location.href='kelola_user_petugas.php'">
                ...
                <div class="action-card" onclick="window.location.href='kelola_transaksi_petugas.php'">
                    <div class="action-icon">
                ...
                <div class="action-card" onclick="window.location.href='backup_restore_petugas.php'">
                    <div class="action-icon">
                        <i class="fas fa-database"></i>
                    </div>
                    <div class="action-title">Backup & Restore</div>
                    <div class="action-desc">Data management</div>
                </div>
