                        ...
                        <?php foreach($products as $product): ?>
                            <tr>
                                <td>
                                    ...
                                    <br>
                                    <span style="color: #6b7280; font-size: 13px;"><?php echo substr($product['description'], 0, 50); ?>...</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a href="ubah_produk.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-warning">
